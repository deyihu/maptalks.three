...
export function vectors2Pixel(worldPoints: Array<number> | Array<THREE.Vector3>, size,
...
export function vector2Pixel(world_vector: THREE.Vector3, size, camera: THREE.Camera): {
    x: number;
    y: number;
} {
    // eslint-disable-next-line camelcase
