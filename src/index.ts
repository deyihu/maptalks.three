...
class ThreeLayer extends maptalks.CanvasLayer {
    ...
    coordinatiesToGLFloatArray(coordinaties: Array<Array<number>>, centerPt: THREE.Vector3, hasHeight?: boolean): {
     ...
     * @return {THREE.Vector3}
     */
    distanceToVector3(w: number, h: number, coord?: any | Array<number>): THREE.Vector3 {
    ...
    altitudeToVector3(altitude: number, altitude1: number, coord?: Array<number>, out?: THREE.Vector3): THREE.Vector3 {
     ...
     * @return {THREE.Shape}
     */
    toShape(polygon: any | any): THREE.Shape | Array<THREE.Shape> {
        if (!polygon) {
            return null;
        }
     ...
     * @param {*} height
     */
    toExtrudeMesh(polygon: any, altitude: number, material: THREE.Material, height: number): THREE.Mesh | Array<THREE.Mesh> {
        if (!polygon) {
            return null;
        }
        if (polygon instanceof maptalks.MultiPolygon) {
     ...
     * @param {THREE.Material} material
     */
    toBar(coordinate: any, options: BarOptionType, material: THREE.Material): Bar {
    ...
    */
     ...
     * @param {*} material
     */
    toPoint(coordinate: any, options: PointOptionType, material: THREE.PointsMaterial): Point {
     ...
     * @param {*} material
     */
    toTerrain(extent: any, options: TerrainOptionType, material: THREE.Material): Terrain {
     ...
     * @param {*} material
     */
    toBox(coorindate: any, options: BarOptionType, material: THREE.Material): Box {
     ...
     * @return {Array}
     */
    identify(coordinate: any, options: object): Array<BaseObject | THREE.Object3D> {
        if (!coordinate) {
